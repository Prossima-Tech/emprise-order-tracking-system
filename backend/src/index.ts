...
async function startServer() {
  ...
  app.use(cors({
    origin: ['http://client.prossimatech.com', 'https://client.prossimatech.com', 'http://ec2-54-157-42-190.compute-1.amazonaws.com', 'https://ec2-54-157-42-190.compute-1.amazonaws.com', 'http://localhost:3000', 'http://localhost:5173'],
    credentials: true,
