    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="font-medium">{site.zoneId}</p>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">
                  Location
        ...
        <TabsContent value="loas">
          <Card>
            <CardHeader>
              <CardTitle>Letter of Acceptance (LOAs)</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <DataTable
                columns={loaColumns as unknown as Column<LOA>[]}
                data={loas}
              />
            </CardContent>
          </Card>
        ...
        <TabsContent value="purchase-orders">
          <Card>
            ...
            <CardContent>
              <DataTable
                columns={poColumns as unknown as Column<PurchaseOrder>[]}
                data={purchaseOrders}
              />
            </CardContent>
          </Card>
